    ...
    function create_fragment$2(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(br0, file$2, 17, 481, 816);
    			attr_dev(a0, "href", "https://github.com/stackwonderflow/Undergroundv2");
    			add_location(a0, file$2, 17, 486, 821);
    			add_location(p0, file$2, 17, 4, 339);
    			add_location(h21, file$2, 18, 4, 906);
    			add_location(br1, file$2, 19, 278, 1207);
    			attr_dev(a1, "href", "https://github.com/eantablin/ConsoleArcade");
    			add_location(a1, file$2, 19, 283, 1212);
    			add_location(p1, file$2, 19, 4, 933);
    			add_location(h22, file$2, 20, 4, 1292);
    			add_location(br2, file$2, 21, 365, 1678);
    			attr_dev(a2, "href", "https://codeinplace-2021.netlify.app/2021/showcase/");
    			add_location(a2, file$2, 21, 370, 1683);
    			add_location(br3, file$2, 21, 453, 1766);
    			attr_dev(a3, "href", "https://codeinplace-2021.netlify.app/2021/showcase/1340");
    			add_location(a3, file$2, 21, 458, 1771);
    			add_location(br4, file$2, 21, 539, 1852);
    			attr_dev(a4, "href", "https://github.com/stackwonderflow/Underground");
    			add_location(a4, file$2, 21, 544, 1857);
    			add_location(p2, file$2, 21, 4, 1317);
